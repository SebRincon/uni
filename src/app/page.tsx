        ...
        <>
            <main className="root">
                ...
                <div className="root-right">
                    <Image src="/assets/unicorn-head-purple.png" alt="" width={40} height={40} />
                    ...
                    <div className="button-group">
                        ...
                        <Tooltip
                            title="You can log in as test account to get full user priviliges if you don't have time to sign up. You can ALSO just look around without even being logged in, just like real Uni!"
                            placement="bottom"
                        >
